...
void TF_101::step() {
	...
	float newValue = clamp(params[PARAM_FONT_SIZE].value + inputs[INPUT_FONT_SIZE].value / 10.0f, 6.0f, 28.0f); 
	...
	if (isDirty) {
		...
		json_object_set_new(rootJ, "fg", colorToJson(nvgRGBf(prevValues[0], prevValues[1], prevValues[2])));
		json_object_set_new(rootJ, "bg", colorToJson(nvgRGBf(prevValues[3], prevValues[4], prevValues[5])));
...
struct TF101 : ModuleWidget {
	TF101(TF_101 *module) : ModuleWidget(module) {
		...
		addParam(ParamWidget::create<sub_knob_small>(Vec(33, 25.5), module, TF_101::PARAM_FG_RED, 0.0f, 1.0f, 0.0f));
		addParam(ParamWidget::create<sub_knob_small>(Vec(33, 60.5), module, TF_101::PARAM_FG_GREEN, 0.0f, 1.0f, 0.0f));
		addParam(ParamWidget::create<sub_knob_small>(Vec(33, 95.5), module, TF_101::PARAM_FG_BLUE, 0.0f, 1.0f, 0.0f));
		...
		addParam(ParamWidget::create<sub_knob_small_snap>(Vec(33, 245.5), module, TF_101::PARAM_FONT_SIZE, 6.0f, 28.0f, 12.0f));
