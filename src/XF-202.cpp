...
struct XF202 : ModuleWidget {
	XF202(XF_202 *module) : ModuleWidget(module) {
		...
		for (int i = 0; i < XF_202::deviceCount; i++) {
			...
			addParam(ParamWidget::create<SubSwitch2>(Vec(28, 154.5 + offset), module, XF_202::PARAM_CV_1 + i, 0.0f, 1.0f, 0.0f));
			addParam(ParamWidget::create<SubSwitch3>(Vec(65, 152 + offset), module, XF_202::PARAM_MODE_1 + i, 0.0f, 2.0f, 0.0f));
